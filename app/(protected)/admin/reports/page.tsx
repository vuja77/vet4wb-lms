...
const INITIAL_VISIBLE_COLUMNS = ["user","message", "role", "status", "actions"];
      ...
      case "user":
        return (
          <User
            avatarProps={{
              radius: "lg",
              src: user.user.photo && `https://moodle.edu4wb.com/storage/${user.user.photo}`,
            }}
            description={user.user.email}
            name={user.user.name} // assuming the user object has a name property
          />
      ...
      case "role":
        return (
          <div className="flex flex-col">
            <p className="text-bold text-small capitalize">{user.role}</p> {/* Assuming role is a property of user */}
            <p className="text-bold text-tiny capitalize text-default-400">
              {user.team} {/* Assuming team is a property of user */}
            </p>
          </div>
        );
      case "status":
          ...
          <div className="relative flex justify-end items-center gap-2">
            <Dropdown>
              ...
              >
                ...
                <DropdownItem key="disabled" onAction={() => changeStatus(user.id, "disabled")}>Disable</DropdownItem>
              </DropdownMenu>
            </Dropdown>
          </div>
        );
          ...
          <div className="relative flex justify-end items-center gap-2">
            <Dropdown>
              ...
              <DropdownMenu>
                ...
                <DropdownItem onAction={() => deleteUsers(user.id)}>Delete</DropdownItem>
              </DropdownMenu>
            </Dropdown>
          </div>
        );
    ...
    <main className="pt-[100px] p-12 w-full  max-md:p-5 max-md:pt-[100px] min-w-[70%] self-center space-y-5">
      <div className="">
        <div className="space-y-1">
          <h4 className="text-3xl font-medium">Reports</h4>
        </div>
