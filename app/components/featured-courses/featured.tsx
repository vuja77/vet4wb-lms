...
export default function Featured({ courses }: { courses: any }) {
    ...
    <>
      <div className="max-w-md">
        <div className="space-y-1">
          <h4 className="text-3xl font-medium text-center">Popular courses</h4>
            ...
            <Card className="py-4 p-0 border hover:border-primary transition-all cursor-pointer h-[420px]">
              <CardBody className="overflow-visible py-2 p-0">
                ...
                <CardFooter className="flex flex-col items-start gap-2">
                  <small className="text-default-500">Author: {e.teacher}</small>
