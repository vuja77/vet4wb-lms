...
export default function Hero({ lang }: any) {
  ...
  return (
    <div className="bg-photo min-w-full  rounded-3xl px-12 max-md:px-3 max-md:flex max-md:flex-col grid grid-cols-3 h-[680px] max-sm:max-h-[600px] max-md:h-space-y-10 max-md:mt-[100px]">
